...
void Show_float(uint16_t x, uint16_t y, float num, uint8_t len, uint8_t size)
{
    if (len == 2)
    {
        int temp1;
        ...
        temp2 = num;
        temp1 = temp2;
        LCD_ShowxNum(x, y, temp1, 1, 16, 0);
        temp2 -= temp1;
        temp2 *= 1000;
        LCD_ShowChar(x + 8, y, '.', 16, 0);
        LCD_ShowxNum(x + 16, y, temp2, 3, 16, 0x80);
    }
    else
    {
        int temp1;
        ...
        temp2 = num*100;
        temp1 = temp2;
        LCD_ShowxNum(x, y, temp1, 2, 16, 0);
        temp2 -= temp1;
        temp2 *= 1000;
        LCD_ShowChar(x + 16, y, '.', 16, 0);
        LCD_ShowxNum(x + 24, y, temp2, 1, 16, 0x80);
        LCD_ShowChar(x + 40, y, '%', 16, 0);
    }
}
